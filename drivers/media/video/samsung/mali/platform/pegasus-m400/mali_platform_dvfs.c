...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
	{800   ,1000000   , 1225000}, // L0
	{733   ,1000000   , 1200000}, // L1
	{640   ,1000000   , 1150000}, // L2
	{533   ,1000000   , 1125000}, // L3
	{440   ,1000000   , 1062500}, // L4
	{350   ,1000000   , 1000000}, // L5
	{266   ,1000000   ,  950000}, // L6
	{160   ,1000000   ,  925000}, // L7
	{108   ,1000000   ,  875000}, // L8
	{54    ,1000000   ,  850000}, // L9
};
...
static unsigned int asv_3d_volt_9_table[MALI_DVFS_STEPS][ASV_LEVEL_PRIME] = {
	{ 1125000, 1112500, 1100000, 1087500, 1075000, 1062500, 1050000, 1037500, 1050000, 1037500, 1012500, 1000000,  987500},	/* L3(533Mhz) */
	{ 1062500, 1050000, 1037500, 1025000, 1012500, 1000000,  987500,  975000,  987500,  975000,  950000,  937500,  925000},	/* L4(440Mhz) */
	{ 1000000,  987500,  975000,  962500,  950000,  937500,  925000,  912500,  925000,  912500,  887500,  875000,  862500},	/* L5(350Mhz) */
	{  950000,  937500,  925000,  912500,  900000,  887500,  875000,  862500,  875000,  862500,  850000,  850000,  850000},	/* L6(266Mhz) */
	{  925000,  912500,  900000,  887500,  875000,  862500,  850000,  837500,  850000,  837500,  825000,  825000,  825000}, /* L7(160Mhz) */
};
#endif /* ASV_LEVEL */
